        ...
        <div className="flex flex-col items-center mt-36 mb-48">
            ...
            <div className="flex gap-4 mt-10">
                <MotionText delay={1.5}>
                    <SocialIcon
                        href="https://www.linkedin.com/in/biplab-sutradhar/"  
                ...
                <MotionText delay={2.5}>
                    <SocialIcon
                        href="https://x.com/BiplabSutr79120"  
                 ...
                 <MotionText delay={3.0}>
                    <SocialIcon
                        href="mailto:biplabsutradhar1453@gmail.com"
                        iconUrl="https://cdn.jsdelivr.net/gh/simple-icons/simple-icons/icons/maildotru.svg" // Updated email icon URL
                        altText="Email"
                    />
                </MotionText>
            </div>
